...
2. Copy the `portfolio-builder` directory and all its files to your `/wp-content/plugins/` directory
...
= 1.0.1 =
* Fixed a bug that prevented the user from simply clicking "Insert into post" when adding media to a portfolio item.
